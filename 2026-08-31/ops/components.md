...
| **lark-cli** | 飞书看板/文档读写（single source of truth 操作面） | npm 全局 CLI | v1.0.91（`lark-cli update` 升级） | `+record-list` 冒烟 | npm uninstall -g | notes/2026-08-07-lark-cli-环境与使用方法.md |
